...
const Experience = () => {
  return (
    <div className=" lg:mt-8 flex flex-col justify-start space-y-12 mx-auto items-center md:mt-20 lg:min-h-screen">
      ...
      <div className="flex flex-col relative space-y-16 md:space-y-10 lg:space-y-8 items-center">
        <div className="flex justify-center select-none space-x-8 items-center my-4  sm:flex-wrap ">
          <svg
        ...
        <p className="text-md px-10">
          As an eager ham radio operator, I love sharing my experiences. Whether setting up my shack or experimenting with homebrew equipment, each moment is an adventure. Check my latest{" "}
          <Link title="Vu2rcy's Involvement: Latest Projects in Radio " href="/work">
          ...
          my journey, passion, and dedication to ham radio. Join me in celebrating recognition and achievements in the radio community. Discover{" "}
