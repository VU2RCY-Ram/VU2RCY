    ...
    <div className=" mt-32 lg:mt-8 flex flex-col justify-start space-y-12 mx-auto items-center md:mt-20 lg:min-h-screen">
      ...
      <div className="w-[80%] mx-auto">
        <div className="text-center max-w-2xl mx-auto tracking-normal leading-5 text-base sm:text-[1.1rem] lg:text-lg">
          Over my {new Date().getUTCFullYear() - 1988} years  in Ham Radio, I&apos;ve explored diverse bands and modes, delving deep into its captivating realm. From 1.8MHz on 160M to 28MHz on 10M, HF has been my playground. VHF offered thrilling opportunities at 50MHz and 144MHz, while UHF presented challenges at 435MHz with my homebrewed MMDVM hotspot. APRS on 144.390MHz and RMS HF systems like PACTOE-1, PACTOE-2, and PACTOE-3 enriched my experience, along with the marvel of satellite communications. Ham radio never ceases to amaze me!
        </div>
      ...
      <div className="w-[80%] max-w-2xl mx-auto">
        this was abt me contact part below
