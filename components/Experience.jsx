    ...
    <div className=" lg:mt-8 flex flex-col justify-start space-y-12 mx-auto items-center md:mt-20 lg:min-h-screen">
      ...
      <div className="flex flex-col relative space-y-16 md:space-y-10 lg:space-y-8 items-center">
        ...
        <p className="text-md">
          ...
          moment is an adventure. Check my{" "}
          <Link href="/work">
            <span className="text-blue-500 hover:underline cursor-pointer">
              latest work
            </span>
          </Link>{" "}
          on exciting radio projects or explore my{" "}
          <Link href="/shack">
            <span className="text-green-500 hover:underline cursor-pointer">
              meticulously crafted shack setup
            </span>
          </Link>
          ...
          , showcasing the joy of building radio equipment from scratch. Learn{" "}
          <Link href="/about">
