...
const Header = () => {
  ...
  return (
    <nav
      ...
      } font-medium duration-500 bg-opacity-90 transition-all linear z-40 dark:text-white w-[90%] sm:w-[75%] md:w-[90%] lg:w-[70%] xl:w-[60%] max-w-6xl mx-auto  bg-white dark:bg-[#353535] drop-shadow-xs backdrop-blur-sm top-4 sticky rounded-2xl `}
    >
